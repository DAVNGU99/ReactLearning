...
const pageSize = pages > 1000 ? "more than 1000" : "less than 1000";

console.log(`There is ${pageSize} pages in this book`);
...
const author = books.map((a) => a.author);
